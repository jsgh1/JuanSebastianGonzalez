...
La consulta debe permitir responder una necesidad como esta: “Mostrar por cada segmento ticketed el asiento asignado, la cabina y el equipaje registrado para el pasajero”.

### Campos esperados en el resultado
Como mínimo, el resultado debe exponer columnas equivalentes a:
- número de tiquete
- secuencia del segmento ticketed
- número de vuelo o segmento
- cabina
- fila del asiento
- columna del asiento
...
### Enunciado
Diseñe un trigger `AFTER INSERT` sobre `baggage` o sobre `seat_assignment` que automatice una acción posterior coherente con el flujo aeroportuario seleccionado.

### Condición funcional del trigger
Al registrarse el evento elegido por el estudiante, el trigger deberá producir una consecuencia verificable sobre otra tabla real del mismo flujo.
...
### Enunciado
Diseñe un procedimiento almacenado que registre el equipaje o la asignación de asiento para un `ticket_segment` existente.

### Propósito del procedimiento
Encapsular una operación aeroportuaria reutilizable sobre un segmento ticketed.

### Alcance funcional mínimo
El procedimiento debe permitir trabajar con información relacionada con:
- segmento ticketed
- asiento o equipaje, según el enfoque elegido
- fecha y hora de registro
- tipo o fuente de asignación
- datos de soporte necesarios existentes en el modelo
...
La operación registrada por el procedimiento debe interactuar con el trigger y permitir validar el efecto posterior sobre el flujo elegido.
...
SELECT b.baggage_tag, b.baggage_status, b.weight_kg, b.checked_at
FROM baggage b
